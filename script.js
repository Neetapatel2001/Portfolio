...
function openGmail() {
  const email = "patelneeta429@gmail.com";
...
function downloadCV() {
  ...
  link.href = "./Neeta Dangi Resume.pdf"; // Path to your resume file
  link.download = "Neeta Dangi Resume.pdf"; // Name for the downloaded file
